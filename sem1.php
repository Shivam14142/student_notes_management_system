...
<div class="dropdown" >
  ...
  <div class="dropdown-content">
     <?php
     $var=$_POST['branch'];
     $sql1="select * from subject where deptid='FY' and scheme=18  ";
...
<div class="dropdown" >
  ...
  <div class="dropdown-content">
     <?php
     $var=$_POST['branch'];
     $sql1="select * from subject where deptid='MAT' and scheme=18 ";
     $sql_row1=mysqli_query($db,$sql1);
      while($sql_res1=mysqli_fetch_assoc($sql_row1))
      {
      ?>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
     <?php
     $var=$_POST['branch'];
     $sql1="select * from subject where deptid='$var' and sem='3' and scheme=18 ";
     $sql_row1=mysqli_query($db,$sql1);
      while($sql_res1=mysqli_fetch_assoc($sql_row1))
      {
      ?>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
     <?php
      $var=$_POST['branch'];
     $sql1="select * from subject where deptid='$var' and sem='4' and scheme=18";
     $sql_row1=mysqli_query($db,$sql1);
      while($sql_res1=mysqli_fetch_assoc($sql_row1))
      {
      ?>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
     <?php
     $var=$_POST['branch'];
     $sql1="select * from subject where deptid='$var' and sem='5' and scheme=18 ";
     $sql_row1=mysqli_query($db,$sql1);
      while($sql_res1=mysqli_fetch_assoc($sql_row1))
      {
      ?>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <?php
    $var=$_POST['branch'];
     $sql1="select * from subject where deptid='$var' and sem='6' and scheme=18 ";
     $sql_row1=mysqli_query($db,$sql1);
      while($sql_res1=mysqli_fetch_assoc($sql_row1))
      {
      ?>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <?php
    $var=$_POST['branch'];
     $sql1="select * from subject where deptid='$var' and sem='7' and scheme=18";
     $sql_row1=mysqli_query($db,$sql1);
      while($sql_res1=mysqli_fetch_assoc($sql_row1))
      {
      ?>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <?php
    $var=$_POST['branch'];
     $sql1="select * from subject where deptid='$var' and sem='8' and scheme=18";
     $sql_row1=mysqli_query($db,$sql1);
      while($sql_res1=mysqli_fetch_assoc($sql_row1))
      {
      ?>
